        ...
        <div className="relative h-full bg-bg-overlay rounded-3xl overflow-hidden">
          ...
          <div className="p-5 sm:p-6 flex flex-col h-[calc(100%-12rem)]">
            ...
            <button
              ...
              className="w-full mt-2 py-2.5 px-6 rounded-xl bg-olive-900/10 hover:bg-olive-900/20 text-text-secondary text-sm font-semibold flex items-center justify-center gap-2 transition-all group-hover:gap-3 border border-olive-900/30"
            >
              View Details
